...
void useMatrixTemplate(Matrix<T1> &M,
        T1 array1[][MAXCOLS], T1 array2[][MAXCOLS]);
...
int main()
{
    ...
    float flo1[MAXROWS][MAXCOLS] =
            {
                {1.6, 2.5, 3.4},
                {4.3, 5.2, 6.1}
            };
    float flo2[MAXROWS][MAXCOLS] =
            {
                    {6.1, 5.2, 4.3},
                    {3.4, 2.5, 1.6}
            };
    ...
    useMatrixTemplate(floatMatrix, flo1, flo2);
